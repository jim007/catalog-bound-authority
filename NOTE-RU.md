# Управление жизненным циклом без хранения содержимого

## Как управлять записями, которые остаются во внешнем хранилище

[English version](NOTE_CATALOG_BOUND_AUTHORITY_EN.md)
